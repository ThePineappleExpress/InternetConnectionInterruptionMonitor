...
# Event table layout
PDF_TBL_COL_W_NUM = 7
PDF_TBL_COL_W_EVENT = 14
PDF_TBL_COL_W_TIME = 10
PDF_TBL_COL_W_DURATION = 10
PDF_TBL_COL_W_DNS = 10
PDF_TBL_COL_W_CAUSE = 10
PDF_TBL_COL_W_IP = 14
PDF_TBL_COL_W_ISP = 38
PDF_TBL_COL_W_LOCATION = 38
PDF_TBL_HDR_H = 8    # header row height
PDF_TBL_ROW_H = 7    # data row height
